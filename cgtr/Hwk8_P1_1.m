...
for i = 1:4
	n = ProbSize(i);
	t0=tic; [x, NumIter(i), NumIterCG(i), e0]=TR_HWK8(100, 0.1, 1e-9, -ones(n,1), @Rosenbrock_wrap); RunTime(i)=toc(t0);
	t1=tic; [x, LDLNumIter(i),LDLNumIterCG(i), e1]=LDLTR_HWK8(100, 0.1, 1e-9,-ones(n,1), @Rosenbrock_wrap); LDLRunTime(i)=toc(t1);
	subplot(2, 2, i);
